...
export const metadata: Metadata = {
  ...
  description:
    'Decision-support platform for disaster-response coordinators combining Demand, Inventory, Mobility, Risk, and Vehicle Dispatch into ranked delivery plans.',
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full antialiased light" suppressHydrationWarning>
      ...
      <body
        className="min-h-full flex flex-col bg-background text-on-surface font-sans"
